...
const EventPage = () => {
  ...
  const imageStyles = {
    backgroundImage: "url(" + event?.photo[photoIndex] + ")",
              ...
              <div className="eventColumnLeft">
                ...
                >
                  <div className="imageArea1 imageArea" onClick={prevPhoto}>
                    {showControls && <i className="fas fa-arrow-left fa-lg" />}
                  </div>
                  <div
                    className="imageArea2 imageArea"
                    onClick={() => setOpen(true)}
                  >
                    {showControls && <i className="fas fa-expand fa-lg" />}
                  </div>
                  <div className="imageArea3 imageArea" onClick={nextPhoto}>
                    {showControls && <i className="fas fa-arrow-right fa-lg" />}
                  </div>
                </div>
